function Card() {
    return (
        <div className="bg-black p-2.5 text-white rounded-2xl inline-block text-right box-border relative top-4">
            ...
            <button className="bg-white text-black px-2.5 py-1.5 rounded-full text-sm font-small hover:bg-[rgb(190,186,186)]">View Product</button>
            <button className="bg-white text-black px-3 py-1.5 rounded-full text-sm font-small ml-4 hover:bg-[rgb(190,186,186)]">Add to Cart</button>
        </div>
    )
}
